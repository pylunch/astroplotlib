; NAME:                histograms_2_idl
;
; DESCRIPTION:         creates a simple coloured histogram from a given set of numbers.
;
; EXECUTION COMMAND:
;                      IDL> .compile histograms_2_idl
;                      IDL> histograms_2_idl
;
...
xrange = [-17., -6.], $
yrange = [0., 3000.], $
polycolor = ['dodger blue', 'royal blue'], $
/fillpolygon, $
datacolorname = "white",$
/normal, $
